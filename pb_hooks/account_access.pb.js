...
onRecordAuthRequest((e) => require(`${__hooks}/account_access.js`).authenticate(e), "agents");
onRecordUpdate((e) => require(`${__hooks}/account_access.js`).update(e), "agents");
onRecordDelete((e) => require(`${__hooks}/account_access.js`).remove(e), "agents");
